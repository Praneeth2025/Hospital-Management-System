...
const PendingTestModal = ({ isOpen, onClose, selectedPatients }) => {
    ...
    const fetchPendingTests = async () => {
      try {
        ...
        for (const patient of selectedPatients) {
          const res = await axios.get(`https://hopsital-management-system-backend.onrender.com/pending-tests/${patient.patient_id}`);
  ...
  const handleSubmit = async () => {
    try {
      ...
      await axios.post("https://hopsital-management-system-backend.onrender.com/update-test-results", {
        updates,
